...
if (!hasSiteUrl && process.env.NODE_ENV === 'production') {
  console.warn(
    '[astro-Answered] SITE_URL is not set. RSS will use example.invalid; canonical/og will be omitted; sitemap will not be generated and robots will not include Sitemap.'
  );
}

export const site = {
  url: hasSiteUrl ? siteUrl : fallbackSiteUrl,
  title: 'Astro Themes by Answered',
  brandTitle: 'Answered',
  author: 'Answered',
  authorAvatar: 'author/Answered.webp',
